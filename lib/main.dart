...
class _NovelbookAIState extends State<NovelbookAI> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://api.codetabs.com/v1/proxy/?quest=https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.3"),
        headers: {
  ...
  Future<void> _actuallyGenerateImage(String prompt) async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://api.codetabs.com/v1/proxy/?quest=https://api-inference.huggingface.co/models/stabilityai/stable-diffusion-xl-base-1.0"),
